(function() {
    ...
    this.WOW = function() {
        ...
        n.prototype.start = function() {
            ...
            this.boxes = function() {
                var t, i, a, n;
                for (a = this.element.querySelectorAll("." + this.config.boxClass),
                n = [],
                t = 0,
                i = a.length; i > t; t++)
                    e = a[t],
        ...
        n.prototype.applyStyle = function(t, e) {
            var i, a, n;
            return a = t.getAttribute("data-nahian-duration"),
            i = t.getAttribute("data-nahian-delay"),
            n = t.getAttribute("data-nahian-iteration"),
            this.animate(function(r) {
                return function() {
                    return r.customStyle(t, e, a, i, n)
                }
            }(this))
        }
        ,
        ...
        n.prototype.vendorSet = function(t, e) {
            ...
            for (i in e)
                ...
                r.push(function() {
                    ...
                    r = s.length; r > e; e++)
                        n = s[e],
                        o.push(t["" + n + i.charAt(0).toUpperCase() + i.substr(1)] = a);
                    return o
                }
                .call(this));
            return r
        ...
        n.prototype.isVisible = function(t) {
            var e, i, a, n, r;
            return i = t.getAttribute("data-nahian-offset") || this.config.offset,
